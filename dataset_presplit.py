...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Dataset Presplit")

    parser.add_argument('--data_dir', dest='data_dir', default="data/beer/",
                        help='Directory path to the dataset. (default: %(default)s)')

    parser.add_argument('--enable_validation', dest='enable_validation',
                        action='store_false',
                        help='Boolean flag indicating if validation is enabled.')
