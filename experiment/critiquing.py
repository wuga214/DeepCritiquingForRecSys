...
def critiquing(num_users, num_items, user_col, item_col, rating_col, keyphrase_vector_col, df_train, keyphrase_names, params, num_users_sampled, load_path, save_path):
    ...
    for index, row in df.iterrows():
        ...
        df_fmap = critiquing_evaluation(model, algorithm, num_users, num_items, num_users_sampled, topk=[5, 10, 20])
