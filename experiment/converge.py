...
def explanation_converge(num_users, num_items, df_train, df_test, keyPhrase, df, table_path, file_name, epochs=10, gpu_on=True):
    progress = WorkSplitter()
    ...
    for run in range(3):
        ...
        for idx, row in df.iterrows():
            ...
            for i in range(epochs//epoch_batch):
                ...
                result = evaluate_explanation(df_valid_explanation, df_test, row['metric'], row['topK'])
