...
from metrics.critiquing_performance import latent_density_evaluation
from plots.rec_plots import show_critiquing


def latent_density_estimation(num_users, num_items, df_train, keyPhrase, params, num_critique, save_path, figure_path):
    ...
    for index, row in df.iterrows():
        ...
        df_result = latent_density_evaluation(model, algorithm, num_users, num_items, num_critique)
